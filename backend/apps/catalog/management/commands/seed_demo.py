    ...
    def handle(self, *args, **options):
        ...
        tracks = [
            Track.objects.create(
                ...
                external_audio_url=SAMPLE_AUDIO[0],
                audio_name='moj-aval.mp3',
            ...
            Track.objects.create(
                ...
                external_audio_url=SAMPLE_AUDIO[1],
                audio_name='panjere-noor.mp3',
                audio_type='audio/mpeg',
            ),
            Track.objects.create(
                title='گام‌های آهسته',
                ...
                external_audio_url=SAMPLE_AUDIO[2],
            ...
            Track.objects.create(
                ...
                external_audio_url=SAMPLE_AUDIO[3],
